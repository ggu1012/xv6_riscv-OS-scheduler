...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    1294:	1ca73823          	sd	a0,464(a4) # 1460 <freep>
      return (void*)(p + 1);
  ...
  free((void*)(hp + 1));
    ...
    12c0:	ec4080e7          	jalr	-316(ra) # 1180 <free>
  return freep;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12e2:	b6c080e7          	jalr	-1172(ra) # e4a <sbrk>
  if(p == (char*)-1)
